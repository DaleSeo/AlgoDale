...
먼저 입력 배열의 첫 번째 구간인 `[2, 3]`을 상대로 두 번째 구간부터 마지막 구간까지 겹치는 부분이 있는 구간을 찾아서 병합해보겠습니다.
...
이 문제를 잘 푸셨다면 비슷하지만 좀 더 어려운 [Insert Interval](/problems/insert-interval/) 문제도 풀어보시라고 추천드리고 싶습니다.
