...
이번에는 TwoSum에 변형된 문제인 [Two Sum II - Input Array Is Sorted](/problems/problems/two-sum-ii-input-array-is-sorted)의 풀이에서 힌트를 얻어 볼까요?

> 마찬가지로 [Two Sum II - Input Array Is Sorted](/problems/problems/two-sum-ii-input-array-is-sorted) 문제를 풀어보시고 돌아오시기를 추천드립니다.
