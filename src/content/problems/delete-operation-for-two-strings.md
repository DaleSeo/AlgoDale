...
왜 `1`이 될까요? 두 문자열의 마지막 글자인 `"a"`와 `"b"`는 다르기 때문에 적어도 둘 중에 하나는 삭제해야 합니다.
...
이렇게 이전 단계에서 계산한 결과를 현재 단계에서 재사용이 가능하다면 [동적 계획법(Dynamic Programming)](/algorithms/dp/)을 적용할 수 있습니다.
