...
[병합 정렬](/algorithms/merge-sort/)과 마찬가지로 퀵 정렬도 분할 정복 (Divide and Conquer) 기법과 재귀 알고리즘을 이용한 정렬 알고리즘입니다.
...
오른편에는 값이 2개가 있기 때문에 추가 정렬이 필요합니다.
...
기존과 동일하게 값의 대소 비교를 위해서는 pivot 값을 사용하지만, 분할의 기준점은 pivot 값이 아닐 수도 있기 때문입니다.
